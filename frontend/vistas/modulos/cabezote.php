	...
	<div class="container">
		<div class="row" id="cabezote">
			...
			<div class="col-lg-3 col-md-3 col-sm-2 col-xs-12 " id="logotipo">
				<a href="#">
					<img src="http://localhost/ecomerce/backend/vistas/img/plantilla/logo.png" alt="no-image =(" class="img-responsive">
				</a>
			</div>
			...
			<div class="input-group col-lg-8 col-md-8 col-sm-8 col-xs-12" id="buscador">
				<input type="search" name="buscar" class="form-control" placeholder="Buscar.."></input>
